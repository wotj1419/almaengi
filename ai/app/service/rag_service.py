...
PRACTICAL_FAQ: list[dict] = [
    ...
    },
    {
        ...
        "law_name": "근로기준법(실무해석)",
        "article": "55·109",
        "keywords": ["주휴수당", "미지급", "주휴수당 처벌", "주휴수당 벌금", "임금체불"],
    },
    {
    ...
    },
    {
        ...
        "law_name": "근로기준법(실무해석)",
        "article": "17·19·114",
        "keywords": ["근로계약서", "근로계약", "구두", "서면", "교부", "근로조건"],
    },
    {
        ...
        "law_name": "근로기준법(실무해석)",
        "article": "26·27",
        "keywords": ["즉시해고", "즉시 해고", "해고 예고", "서면통지", "서면", "해고사유"],
    },
    {
